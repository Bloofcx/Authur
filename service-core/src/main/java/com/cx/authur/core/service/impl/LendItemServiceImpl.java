...
import com.cx.authur.core.mapper.LendItemMapper;
...
public class LendItemServiceImpl extends ServiceImpl<LendItemMapper, LendItem> implements LendItemService {
    ...
    public String commitInvest(InvestVO investVO) {
        ...
        BigDecimal amount = userAccountService.getAmtByUserId(investUserId);//获取当前用户的账户余额
    ...
    public void notify(Map<String, Object> paramMap) {
        ...
        boolean result = transFlowService.isExists(agentBillNo);
        if(result){
            log.warn("幂等性返回");
            return;
        }
        ...
        userAccountMapper.updateUserAccount(new BigDecimal("-" + voteAmt),new BigDecimal(voteAmt),bindCode);
